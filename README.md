...
# Acknowledgements
I had been thinking about this kind of algorithm alone for years and have received polarized feedback with headache :-( axxxxxx words from a person). The idea of multi-particle came into my mind in Winnipeg when I was doing some research for Christopher Henry. The concept of kinetic energy $K_r$ was conceived in collaboration with Hongji Yang and others.
