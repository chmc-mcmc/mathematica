...
pAll=RandomVariate[ND,{PARTICLES,Dim}];
KtotalNew = Sum[If[vanilla,pAll[[i]].pAll[[i]],pAll[[i]]. LinearSolve[Apply[ddU,qAll[[i]]],pAll[[i]]]]/2,{i,1,PARTICLES}];Utotal=Sum[Apply[ U,qAll[[i]]],{i,1,PARTICLES}];Htotal=If[vanilla,Htotal1,Htotal2];dt=If[vanilla,dt1,dt2];Ktotal=Htotal-Utotal;pAll=pAll Sqrt[Abs[Ktotal/KtotalNew]];ES={};AS={};For[i=1,i<=PARTICLES,i++,
p=pAll[[i]];
q=qAll[[i]];
UE={Apply[ U,q]};
q0=q;
